...
export const SAMPLE_MOVIES = [
  ...
  },
  {
    ...
    "overview": "An epic martial fantasy journey of Wang Lin as he defiance the celestial realms and fights ancient gods to protect his loved ones.",
    "popularity": 188.0818,
  ...
  },
  {
    ...
    "overview": "A strange doorway appears in the basement of a furniture showroom, leading into infinite yellow-wallpapered hallways.",
    "popularity": 176.1763,
...
export function getPosterUrl(path, width = 'w500') {
  if (!path) return getPlaceholderPoster();
  if (path.startsWith('http')) return path;
  return `https://image.tmdb.org/t/p/${width}${path}`;
}

export function getBackdropUrl(path, width = 'w1280') {
